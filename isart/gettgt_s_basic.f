...
c
      real    dopscore(nsr) , rdscore(nsr) , strong_targs_dop
c
      integer target_index , k , dopcell(nsr) , rdcell(nsr) , slbkilled
c
c-----------------------------------------------------------------------
c
c   Include files
...
c
         enddo
c      
         call sort ( dopscore , nsr , dopcell )
...
c
         enddo
c      
         call sort ( rdscore , nsr , rdcell )
c 
         k = 0
c
         do  j = 1 , 5
c
            target_index = rdcell(nsr-j-k+1)
c    
            do while ( ( ( nsr - j - k + 1 ) .gt. 0 ) .and. 
...
c
               do while ( ( target_index + i .le. nsr ) .and. 
